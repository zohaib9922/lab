...
if ( ! class_exists( 'FAQ_Woocommerce', false ) ) :
    ...
    final class FAQ_Woocommerce {
        ...
        public function ffw_add_action_links($actions) {
            ...
            $pro_link   = sprintf('<a href="%1$s" class="ffw-action-link-go-pro" style="background: #d3135a;font-weight: 500;padding: 5px 10px;color: #fff;text-transform: uppercase;font-size: 0.7rem;"><span>★</span> %2$s</a>', FFW_PRO_URL, esc_html__('Go Pro', 'faq-for-woocommerce'));
            $ffw_links  = array($setting, $pro_link);
