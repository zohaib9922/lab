...
if( ! function_exists( 'get_product_faqs' ) ) {
    function get_product_faqs( $product_id ) {
        if ( isset($product_id) && ! empty($product_id) ) {
            ...
            $faq_post_ids = apply_filters('ffw_filter_faq_post_ids', $faq_post_ids);
...
function ffw_get_settings_page_menu_title() {
    return apply_filters('ffw_filter_settings_page_menu_title', esc_html__('XPlainer – WooCommerce Product FAQ', 'faq-for-woocommerce'));
}
